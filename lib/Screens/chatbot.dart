...
class _ChatBotState extends State<ChatBot> {
  ...
  void response(String query) async{
    df.AuthGoogle authGoogle = await df.AuthGoogle(fileJson: 'assets/blooddonor-294218-1468031223dd.json').build();
    ...
    if(response.queryResult!=null) {
      setState(() {
        ...
        print(response.queryResult.fulfillmentText.toString());
      });
    }
    else{
      print("NO data");
